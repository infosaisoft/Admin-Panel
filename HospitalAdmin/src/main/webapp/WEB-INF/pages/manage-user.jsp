						...
						<tbody>
							<c:forEach var="user" items="${userDto}">
								<tr>
									...
									<td><img src="assets/images/hospital/${user.photo }"
									...
									<td><a href="login-history?admin_id=${user.admin_id}"
										type="button" class="btn btn-info btn-sm"> View </a></td>
									<td><a href="edit_admin?admin_id=${user.admin_id}"
										type="button" class="btn btn-primary btn-sm CursorPointer"
										data-toggle="tooltip" data-placement="top" title="Edit User">
											<i class="far fa-edit"></i>
									</a> <a href="delete_admin?admin_id=${user.admin_id}"
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-6">
								...
								<form:select class="form-control selectDoc" path="dpt_name"
									required="true">
