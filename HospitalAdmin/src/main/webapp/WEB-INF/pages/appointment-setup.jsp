						...
						<table class="table table-bordered table-custom table-shift">
							<thead class="thead-light">
								<tr>
									...
									<th>
										<p class="week-head">Mon Shift</p> <form:select
											class="form-control multiSelect" path="mon"
									...
									<th>
										<p class="week-head">Tue Shift</p> <form:select
											class="form-control multiSelect" path="tue"
											multiple="multiple" size="5" required="true">
											<form:options items="${shiftlist.shift}" />
											<form:option value="Off">Off</form:option>
										</form:select>
									...
									<th>
										<p class="week-head">Wed Shift</p> <form:select
											class="form-control multiSelect" path="wed"
											multiple="multiple" size="5" required="true">
											<form:options items="${shiftlist.shift}" />
											<form:option value="Off">Off</form:option>
										</form:select>
									...
									<th>
										<p class="week-head">Thur Shift</p> <form:select
											class="form-control multiSelect" path="thu"
											multiple="multiple" size="5" required="true">
											<form:options items="${shiftlist.shift}" />
											<form:option value="Off">Off</form:option>
										</form:select>
									...
									<th>
										<p class="week-head">Fri Shift</p> <form:select
											class="form-control multiSelect" path="fri"
											multiple="multiple" size="5" required="true">
											<form:options items="${shiftlist.shift}" />
											<form:option value="Off">Off</form:option>
										</form:select>
									...
									<th>
										<p class="week-head">Sat Shift</p> <form:select
											class="form-control multiSelect" path="sat"
											multiple="multiple" size="5" required="true">
											<form:options items="${shiftlist.shift}" />
											<form:option value="Off">Off</form:option>
										</form:select>
									...
									<th>
										<p class="week-head">Sun Shift</p> <form:select
											class="form-control multiSelect" path="sun"
											multiple="multiple" size="5" required="true">
											<form:options items="${shiftlist.shift}" />
											<form:option value="Off">Off</form:option>
										</form:select>
